---
title: "SCF Guide: Analyzing the Survey of Consumer Finances"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{SCF-guide}
...
if (requireNamespace("dplyr", quietly = TRUE)) {
  ...
  message("dplyr not available; vignette chunks disabled.")
}
...
scf_glm(scf2022, npeople ~ age + log_income, family = poisson())
```
...
- Cohen, Joseph N. (2025). "Analyzing the Survey of Consumer Finances: A Guide to the `scf` Package" Mimeo.
- Federal Reserve Board. (2023). *Survey of Consumer Finances*. [https://www.federalreserve.gov/econres/scfindex.htm](https://www.federalreserve.gov/econres/scfindex.htm)
