...
#' applies the same `cut()` breaks across implicates, and computes Rubin-pooled
#' frequencies with [scf_freq()]. Results are filtered to remove bins with undefined
#' proportions and then plotted using `ggplot2::geom_col()`.
#'
...
#' }
#'
#' @seealso [scf_freq()], [scf_plot_dbar()], [scf_plot_smooth()]
#' @export
